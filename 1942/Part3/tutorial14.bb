...
While PlayerIsAlive
	...
	;Comment out this section if using a regular joystick
	;Here we're using bitwise logic to determine if the pause button is pressed
	if GameB(1) & #BTN_REVERSE = #BTN_REVERSE
		X - 2
	endif
	if GameB(1) & #BTN_FORWARD = #BTN_FORWARD
		X + 2
	endif
	if GameB(1) & #BTN_PAUSE = #BTN_PAUSE
		End
	endif
