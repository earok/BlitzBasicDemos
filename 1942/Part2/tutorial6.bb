...
;Shot position. We're using the "quick" type for sub-pixel sprite positioning
;We're positioning the sprite outside of the screen by default
ShotX.q=-100
ShotY.q=-100
...
While Joyb(0)=0
	...
	;Handle the sprite for shot. We don't need to move it if it's already off screen
	;Move it by 5.5 pixels per frame
	if ShotY > -100
		ShotY - 5.5		
	endif
	;Draw the sprite on screen
	DisplaySprite #COPPERLIST_MAIN,#SPRITE_SHOT,#XOFFSPRITE+ShotX,ShotY,0
	;The above should be self explanatory, except '0' simply means the first
	;of eight sprite channels
