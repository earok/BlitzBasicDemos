...
While Joyb(0)=0
	...
	;At an X Position of 0
	;And a Y Position of Y
	DisplayBitMap #COPPERLIST_MAIN,#BITMAP_BACKGROUND,0,Y

	;Adjust Y by the joystick position
	Y + JoyY(1)
	;1 = joystick 1 (0 would mean mouseport joystick)
	
	;Wrap the value around so we don't go out of bounds
	Y = QWrap(Y,0,512)
